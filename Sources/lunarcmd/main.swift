...
do {
    ...
    if argv.contains("--width") {
        lunarCmd.arguments?.append("--width")
        lunarCmd.arguments?.append(argv[argv.firstIndex(of: "--width")! + 1])
    }
    if argv.contains("--height") {
        lunarCmd.arguments?.append("--height")
        lunarCmd.arguments?.append(argv[argv.firstIndex(of: "--height")! + 1])
    }
    if os == "darwin" {
